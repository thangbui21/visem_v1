<template>
  <div class="tables-basic">
    <b-row>
      ...
      <!--
        <div>
          <b-button v-b-modal.modal2 variant="default" style="float: right"
            >Knowledge Objects</b-button
          >
          <CreateReport />
        </div>
        -->
            ...
            <b-col cols="3" md="auto" stylee="border-color:white">
              ...
              >
                <b-dropdown-item
                  v-for="item in items"
                  :key="item.text"
                  v-on:click="changeItem('Owner', item.text)"
            ...
            <b-col cols="1" md="auto">
              ...
              >
                <b-dropdown-item
                  ...
                  :key="owner.text"
                  v-on:click="changeItem('visible-app', owner.text)"
...
export default {
  ...
  data() {
    return {
      page: 1,
      app_dropdown: 'App: V-SIEM',
      owner_dropdown: 'Owner: Any',
      visible_app: 'visible-app: any',
      totalRecords: 20,
      expanded: [],
  ...
  methods: {
    changeItem: function (refName, item) {
      ...
      } else if(refName === 'visible-app'){
        this.visible_app = refName+': '+item;
      }
    },
  },
};
